...
Para cumplir con el objetivo planteado llevamos a cabo un Intento de intrusión externo sobre los siguientes rangos de direcciones IP provistas por la compañía:
            ...
            self["percentage-paragraph"] = "Se han detectado [cant vulnerabilidades] vulnerabilidades, de las cuales [cant altas] han sido catalogadas como altas, [cant medias] como media, [cant bajas] como bajas"
            self["cant"] = "Cantidad"
            self["high-risk"] = "Alta"
