...
class Language(dict):
    ...
    def __init__(self,language):
        ...
        if(language == 'en'):
            ...
            self["vulnerabilities-identification-paragraph"] = "Using the information acquired during the port scanning and the acquisition of banners, the professionals of BTR Consulting carried out a search for vulnerabilities using their own tools, others available on the Internet and manual techniques in order to be able to detect the existing weaknesses in the open ports."
