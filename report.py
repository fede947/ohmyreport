...
class Report:
    ...
    def executiveSummary(document, vulnerabilities, language, client):
        ...
        document.add_paragraph(language["introduction-paragraph-2"])
        document.add_paragraph(language["introduction-paragraph-3"])
        document.add_paragraph(language["introduction-paragraph-4"])
        document.add_paragraph(language["introduction-paragraph-5"])
    ...
    def discovery(document, ips, language, client, nmap):
        ...
        document.add_paragraph(language["discovery-paragraph-4"])
        document.add_paragraph(language["discovery-paragraph-5"])
        document.add_paragraph(language["discovery-paragraph-6"])
        document.add_paragraph(language["discovery-paragraph-7"])
        document.add_paragraph(language["discovery-paragraph-8"])
        document.add_paragraph(language["discovery-paragraph-9"])
